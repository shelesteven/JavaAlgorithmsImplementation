...
public class ExponentiationTest {
    ...
    public void recusriveExponentiationTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++) {
            final long x = Exponentiation.recursiveExponentiation(baseList.get(i), exponentList.get(i));
            final long r = expectedResultList.get(i);
            assertEquals(r, x);
        }
    }
    ...
    public void fastRecusriveExponentiationTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++) {
            final long r = expectedResultList.get(i);
            final long x = Exponentiation.fastRecursiveExponentiation(baseList.get(i), exponentList.get(i));
            assertEquals(r, x);
        }
    }
    ...
    public void fastRecusriveExponentiationModuloTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++) {
            final long r = expectedResultList.get(i);
            final long x = Exponentiation.fastRecursiveExponentiationModulo(baseList.get(i), exponentList.get(i), divisorList.get(i));
            assertEquals(r, x);
        }
    }
}
